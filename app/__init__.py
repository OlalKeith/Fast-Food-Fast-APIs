...
def create_app(config_name= 'testing'):
	...
	from app.api.views_orders import get_all_orders_view 
	from app.api.views_orders import get_single_order_view
	from app.api.views_orders import update_meal_view
	from app.api.views_orders import delete_meal_view
	from app.api.views_orders import place_order_view
